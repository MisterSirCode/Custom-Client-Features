private void LoadGraphics()
{
    ...
    })
    {
        ...
        spriteLayer.masks = SpriteHelper.SequentialMaskInfoList(new List<object>
        {
            "masks/decay-" + str,
            3
        });
        ...
        spriteLayer2.sprites = SpriteHelper.SequentialSpriteInfoList(new List<object>
        {
            "mask_borders/decay-" + str,
            3
        }, 0f, false);
