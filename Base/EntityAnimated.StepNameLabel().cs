private void StepNameLabel(Rect screenRect) {
    if (this.nameLabel != null) {
        ...
        if (this.IsVisibleOffscreen()) {
            ...
            this.distance = new Vector2(ReplaceableSingleton<Zone>.main.cameraRect.center.x, -ReplaceableSingleton<Zone>.main.cameraRect.center.y) - new Vector2(this._transform.position.x, this._transform.position.y);
